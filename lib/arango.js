...
Arango.prototype.all = function(model, filter, callback) {
    console.log("ALLLL", model, filter, callback);
    var key;
    var self = this;
    ...
    var resultFunction = function(err, res, hdr) {
        ...
        if (err) {
            ...
            //console.log("HMM", res.result.map(mapFn));//function(o) { o = self.fromDatabase(model, o); o.id = o._id; delete o._id; return o; }));
            callback(null, res.result.map(function(o) { 
                o = self.fromDatabase(model, o);
                o.id = o._id;
                delete o._id;
                console.log("O", o);
